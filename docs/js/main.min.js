...
/* harmony import */ var _modules_contacts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/contacts */ "./js/modules/contacts.js");
/* harmony import */ var _modules_contacts__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_contacts__WEBPACK_IMPORTED_MODULE_6__);
...
function activateContacts() {
  var containerElement = document.querySelector('#contacts__map');
...
if (product) {
  ...
  var productImages = product.querySelectorAll('.product__image');
  var productText = product.querySelector('.product__text');
  var productWrapper = product.querySelector('.product__wrapper');
  var productImagesLength = productImages.length.toString();
  ...
  var setProductBackground = function setProductBackground() {
    var productImageLeft = firstImage.getBoundingClientRect().left;
...
if (contacts) {
  var _partnersBackground = document.querySelector('.contacts__background');

  var setContactsBackground = function setContactsBackground() {
    var headerContactsProductLeft = headerContacts.getBoundingClientRect().left;

    _partnersBackground.style.setProperty('--backgroundContactsWidth', window.innerWidth - headerContactsProductLeft + 'px');
  };
